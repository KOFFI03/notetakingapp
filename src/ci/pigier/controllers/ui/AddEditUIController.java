...
public class AddEditUIController extends BaseController implements Initializable {
    ...
    void doSave(ActionEvent event) throws IOException {
        ...
        if (editNote != null)
        	updateNoteInDatabase(new Note(editNote.getID(), titleTxtFld.getText(), descriptionTxtArea.getText()));
        else
        	addNoteToDatabase(new Note(0, titleTxtFld.getText(), descriptionTxtArea.getText()));
